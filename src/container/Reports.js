...
const Reports = () => {
    ...
    return (
        <Layout>
            ...
            <Row>
                <Col xs={4} lg={3} md={3}>
                    <MetricCard title="Engagement" tooltipText="Overall engagement statistics">
                        <div className="col-md-6">
                            <Metrix title="Likes" operation="1000+" column="col1" jsonData={reportsData} />
                            <Metrix title="Shares" operation="ratio" column="col1" jsonData={reportsData} />
                        </div>
                        <div className="col-md-6">
                            <Metrix title="Comments" operation="ratio" column="col3,col2" jsonData={reportsData} />
                            <Metrix title="Reach" operation="total" column="col1" jsonData={reportsData} />
                        </div>
                    </MetricCard>
                </Col>
                <Col xs={4} lg={3} md={3}>
                ...
                <Col xs={4} lg={3} md={3}>
                    <MetricCard title="Follower Growth" tooltipText="Overall engagement statistics">
                        <div className="col-md-6">
                            <Metrix title="Likes" operation="1000+" column="col1" jsonData={reportsData} />
                            <Metrix title="Shares" operation="ratio" column="col1" jsonData={reportsData} />
                        </div>
                ...
                <Col xs={4} lg={3} md={3}>
                    <MetricCard title="Conversions" tooltipText="Overall engagement statistics">
                        <div className="col-md-6">
                            <Metrix title="Likes" operation="1000+" column="col1" jsonData={reportsData} />
                            <Metrix title="Shares" operation="ratio" column="col1" jsonData={reportsData} />
                        </div>
            ...
            <div className="form-group row p-3 gap-2 text-center">
                ...
                <Modal isOpen={isModalOpen} onClose={() => setModalOpen(false)} title="A/B Testing">
